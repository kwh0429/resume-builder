...
- **🎨 6가지 맞춤형 디자인 템플릿 테마**:
  - **🌈 레인보우 파스텔**: 화사하고 감각적인 멀티컬러 테마
  - **🌊 모던 오션 블루**: 신뢰감과 전문성을 주는 코발트 & 아쿠아 톤
  - **🌿 네이처 포레스트**: 차분하고 싱그러운 에메랄드 & 세이지 그린 톤
  - **🌸 로즈 핑크**: 부드럽고 세련된 로즈 골드 & 핑크 톤
  - **🖤 모던 차콜**: 깔끔하고 절제된 미니멀 흑백 & 슬레이트 그레이 톤
  - **🌌 미드나잇 다크**: 눈이 편안하고 트렌디한 네온 악센트 다크 테마
- **🎯 2가지 맞춤형 작성 모드**:
  - **🌱 일반 모드 (Prompt A)**: 신입 및 초보자를 위한 정갈하고 깔끔한 표준 양식
  - **🚀 전문가 모드 (Prompt B)**: STAR 기법 기반, 구체적인 수치와 비즈니스 임팩트를 극대화한 시니어 양식
- **⚡ 실시간 마크다운 & 테마 즉시 변환**: 생성 전후 언제든 클릭 한 번으로 이력서 색상 테마를 실시간 변경
